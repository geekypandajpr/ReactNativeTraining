...
export default class DetailsView1 extends React.Component {
    render() {
            ...
            <View style={styles.card_view}>
                ...
                <View style={styles.third_region}>
                    <View style={styles.third_region_1}>                        
                        <MaterialCommunityIcons name='barcode-scan' color='#fff' size={60} />
                    </View>
                    ...
                    <View style={styles.third_region_container}>
                        ...
                        <View style={styles.third_region_2}>
                            ...
                            <View style={styles.third_region_text_view}>
                                <Text style={styles.third_region_small_text}>84/122 Sector 8 Pratap Nagar</Text>
                            </View>
                        </View>
